...
function LoginForm() {
  ...
  function getErrorMessage(errorKey: string | null): string | null {
    ...
    if (errorKey === 'auth_failed') return t('invalidCredentials');
    if (errorKey === 'fillAllFields') return t('fillAllFields');
    ...
    <form onSubmit={handleSubmit} className="space-y-5">
      ...
      <div className="relative">
        ...
        <div className="relative flex justify-center text-sm">
          <span className="bg-[#060606] px-3 text-white/40">{t('orContinueWithEmail')}</span>
        </div>
      </div>
      ...
      <div>
        ...
        <input
          ...
          className="w-full px-3 py-2 border border-white/[0.1] rounded-lg text-sm text-white bg-white/[0.05] placeholder:text-white/25 focus:outline-none focus:ring-2 focus:ring-emerald-500/30 focus:border-emerald-500/40"
      ...
      <div className="flex items-center justify-between">
        <div className="flex items-center gap-2">
          <input
            ...
            className="h-4 w-4 rounded border-white/[0.1] bg-white/[0.05] accent-emerald-500"
          />
