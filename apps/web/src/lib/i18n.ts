...
export const translations = {
  ...
  backToDashboard: { he: 'חזרה ללוח הבקרה', en: 'Back to dashboard' },
  totalRecipients: { he: 'סה"כ נמענים', en: 'Total Recipients' },
  noRecipients: { he: 'לא נמצאו נמענים', en: 'No recipients found' },
  all: { he: 'הכל', en: 'All' },
  valid: { he: 'תקינים', en: 'Valid' },
  invalid: { he: 'לא תקינים', en: 'Invalid' },
  duplicate: { he: 'כפולים', en: 'Duplicate' },
  previous: { he: 'הקודם', en: 'Previous' },
  page: { he: 'עמוד', en: 'Page' },
  pending: { he: 'ממתין', en: 'Pending' },
  name: { he: 'שם', en: 'Name' },
  composeMessageDesc: { he: 'כתבו את ההודעה שלכם והוסיפו משתנים להתאמה אישית לכל נמען.', en: 'Write your message and insert variables to personalize it for each recipient.' },
  campaignCost: { he: 'עלות קמפיין', en: 'Campaign cost' },
  yourBalance: { he: 'היתרה שלכם', en: 'Your balance' },
  sufficient: { he: 'מספיק', en: 'Sufficient' },
  insufficient: { he: 'לא מספיק', en: 'Insufficient' },
  previewAs: { he: 'תצוגה מקדימה כ:', en: 'Preview as' },
  startTypingPreview: { he: 'התחילו להקליד כדי לראות תצוגה מקדימה...', en: 'Start typing to see a preview...' },
  clear: { he: 'נקה', en: 'Clear' },
  credit: { he: 'קרדיט', en: 'credit' },
  noTemplate: { he: 'לא הוגדרה תבנית הודעה', en: 'No message template set' },
  sendNowDesc: { he: 'התחילו לשלוח מיד לאחר האישור', en: 'Start sending immediately after confirmation' },
  scheduleDesc: { he: 'בחרו תאריך ושעה', en: 'Pick a specific date and time' },
  confirmSendDesc: { he: 'שלחו עכשיו ל-', en: 'Send now to' },
  willDeduct: { he: 'ינוכו', en: 'This will deduct' },
